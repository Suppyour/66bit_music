...
const EditSongModal: React.FC<EditSongModalProps> = ({ isOpen, onClose, onEdit, isUploading, initialData }) => {
        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="modal-header">
                    ...
                    <h2 className="modal-title">Изменить песню</h2>
                </div>
                            ...
                            {audioFileName ? (
                                ...
                                <>
                                    ...
                                    <p className="drag-drop-text">
                                        Перетащите новый аудио/видео сюда или нажмите для выбора
                                    </p>
                        ...
                        <div className={`drag-drop-zone ${coverImagePreview ? 'has-preview' : ''}`}>
                            {coverImagePreview ? (
                                ...
                                <>
                                    ...
                                    <p className="drag-drop-text">
                                        Перетащите новую обложку сюда или нажмите для выбора
                                    </p>
